            ...
            <div className="space-y-2">
              {isLoading ? (
                ...
                conversations.map((conv) => (
                  <div
                    key={conv.session_id}
                    className={`relative group cursor-pointer p-4 rounded-xl transition-all hover:bg-gray-50 border-2 border-transparent hover:border-blue-100 ${loadingAction === conv.session_id ? 'opacity-50 pointer-events-none' : ''
                      }`}
                  ...
                  >
                    <div className="flex items-start justify-between">
                      ...
                      <button
                        ...
                        className={`p-1.5 rounded-lg transition-all opacity-0 group-hover:opacity-100 ${showDeleteConfirm === conv.session_id
