...
class BitacoraService:
    ...
    async def registrar_ingesta(
        ...
        Función especializada para el módulo de ingesta asíncrona.
    ...
    async def registrar_almacenamiento_vectorial(
        ...
        Función especializada para el módulo de ingesta - fase de vectorización.
    ...
    async def registrar_busqueda_similares(
        ...
        Función especializada para el módulo de búsqueda de similares.
    ...
    async def registrar_resumen_ia(
        ...
        Función especializada para el módulo de resúmenes de IA de casos similares.
