...
from app.schemas.ingesta_schemas import IngestaArchivosRequest, IngestaArchivosResponse
...
async def ingestar_archivos(
    ...
    respuesta_simplificada = generar_respuesta_simplificada(
        resultado_completo, CT_Num_expediente
    )
